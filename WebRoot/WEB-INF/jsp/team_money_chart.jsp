...
<div class="chart-title">
	<h3 id="title_text">
		<spring:message code="week_manage" />
	</h3>
</div>
<div>
...
<div
	class="chart-note chart-note-color chart-note-green chart-note-left"></div>
		...
		jQuery.ajax({
			...
			success : function(json) {
				if (json.message != '') {
					...
					if(data=='no-data'){
						jQuery("#title_text").append("[<spring:message code="chart_no_data" />]");
					}else{
