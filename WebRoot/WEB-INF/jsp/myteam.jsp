				...
				<ul
					...
					<li
						...
						<ul style="height: 225px;">
							...
							<li class="divider"></li>
							<li>
								<spring:message code="ticket_price" />
								:${team.arena.ticket_price} &nbsp;&nbsp;
								<i class="fa fa-ticket fa-cursor-right"
									title="<spring:message code="ticket_price_tip"/>"> </i>
				...
				<c:forEach items="${team_players}" var="player" varStatus="status">
					<ul
						...
						<li
							...
							jcarouselindex="2"
							style="float: left; list-style: none; width: 218px !important; height: 575px; margin-top: 0px">
							<ul>
								<li class="title">
									<div class="contain">
								...
								<li>
									<spring:message code='sign_salary' />
									:
									<h8>
									${player.sign_sal}
									</h8>
